...
func (s *MySuite) TestFormatDateTime(c *C) {
	...
	dFull, err := tEn.FormatDateTime(DateFormatFull, datetime)
	c.Check(err, IsNil)

	dLong, err := tEn.FormatDateTime(DateFormatLong, datetime)
	c.Check(err, IsNil)

	dMedium, err := tEn.FormatDateTime(DateFormatMedium, datetime)
	c.Check(err, IsNil)

	dShort, err := tEn.FormatDateTime(DateFormatShort, datetime)
	c.Check(err, IsNil)

	tFull, err := tEn.FormatDateTime(TimeFormatFull, datetime)
	c.Check(err, IsNil)

	tLong, err := tEn.FormatDateTime(TimeFormatLong, datetime)
	c.Check(err, IsNil)

	tMedium, err := tEn.FormatDateTime(TimeFormatMedium, datetime)
	c.Check(err, IsNil)

	tShort, err := tEn.FormatDateTime(TimeFormatShort, datetime)
	c.Check(err, IsNil)

	dtFull, err := tEn.FormatDateTime(DateTimeFormatFull, datetime)
	c.Check(err, IsNil)

	dtLong, err := tEn.FormatDateTime(DateTimeFormatLong, datetime)
	c.Check(err, IsNil)

	dtMedium, err := tEn.FormatDateTime(DateTimeFormatMedium, datetime)
	c.Check(err, IsNil)
...
func (s *MySuite) TestFormatDateTimeComponent(c *C) {
	f, _ := NewTranslatorFactory(
		[]string{"data/rules"},
		[]string{"data/messages"},
		"en",
	...
	str, err := tEn.formatDateTimeComponent(datetime, "G")
	c.Check(err, IsNil)
	c.Check(str, Equals, "")

	str, err = tEn.formatDateTimeComponent(datetime, "y")
	c.Check(err, IsNil)
	c.Check(str, Equals, "2006")

	str, err = tEn.formatDateTimeComponent(datetime, "yy")
	c.Check(err, IsNil)
	c.Check(str, Equals, "06")

	str, err = tEn.formatDateTimeComponent(datetime, "yyyy")
	c.Check(err, IsNil)
	c.Check(str, Equals, "2006")

	_, err = tEn.formatDateTimeComponent(datetime, "yyyyyy")
	c.Check(err, NotNil)

	str, err = tEn.formatDateTimeComponent(datetime, "M")
	c.Check(err, IsNil)
	c.Check(str, Equals, "1")

	str, err = tEn.formatDateTimeComponent(datetime, "MM")
	c.Check(err, IsNil)
	c.Check(str, Equals, "01")

	str, err = tEn.formatDateTimeComponent(datetime, "MMM")
	c.Check(err, IsNil)
	c.Check(str, Equals, "Jan")

	str, err = tEn.formatDateTimeComponent(datetime, "MMMM")
	c.Check(err, IsNil)
	c.Check(str, Equals, "January")

	str, err = tEn.formatDateTimeComponent(datetime, "MMMMM")
	c.Check(err, IsNil)
	c.Check(str, Equals, "J")

	_, err = tEn.formatDateTimeComponent(datetime, "MMMMMM")
	c.Check(err, NotNil)
	...
	str, err = tEn.formatDateTimeComponent(datetime, "d")
	c.Check(err, IsNil)
	c.Check(str, Equals, "2")

	str, err = tEn.formatDateTimeComponent(datetime, "dd")
	c.Check(err, IsNil)
	c.Check(str, Equals, "02")

	_, err = tEn.formatDateTimeComponent(datetime, "dddddd")
	c.Check(err, NotNil)
	...
	str, err = tEn.formatDateTimeComponent(datetime, "s")
	c.Check(err, IsNil)
	c.Check(str, Equals, "5")

	str, err = tEn.formatDateTimeComponent(datetime, "ss")
	c.Check(err, IsNil)
	...
	str, err = tEn.formatDateTimeComponent(datetime, "aaa")
	c.Check(err, IsNil)
	c.Check(str, Equals, "abbr")
	str, err = tEn.formatDateTimeComponent(datetime, "aaaa")
	c.Check(err, IsNil)
	c.Check(str, Equals, "wide")
	...
	str, err = tEn.formatDateTimeComponent(datetime, "Q")
	c.Check(err, IsNil)
	c.Check(str, Equals, "")

	str, err = tEn.formatDateTimeComponent(datetime, "z")
	c.Check(err, IsNil)
	c.Check(str, Equals, "")

	str, err = tEn.formatDateTimeComponent(datetime, "v")
	c.Check(err, IsNil)
	c.Check(str, Equals, "")

	_, err = tEn.formatDateTimeComponent(datetime, "%")
	c.Check(err, NotNil)
}

func (s *MySuite) TestParseDateTimeFormat(c *C) {
	f, _ := NewTranslatorFactory(
		[]string{"data/rules"},
		[]string{"data/messages"},
		"en",
...
func (s *MySuite) TestGetDateTimePattern(c *C) {
...
func (s *MySuite) TestLastSequenceIndex(c *C) {
	str := "a"
